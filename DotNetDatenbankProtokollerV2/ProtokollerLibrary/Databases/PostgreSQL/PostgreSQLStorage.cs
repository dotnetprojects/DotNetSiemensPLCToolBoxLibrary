                    ...
                    while (e1.MoveNext() && e2.MoveNext())
                    {
                        ...
                        switch (field.PLCTag.LibNoDaveDataType)
                        {
                            ...
                            case DotNetSiemensPLCToolBoxLibrary.DataTypes.TagDataType.BCDDWord:
                                myCmd.Parameters.Add(new NpgsqlParameter("@" + field.DatabaseField, System.Data.DbType.String) { Value = value.ToString() });
                                break;
                            case DotNetSiemensPLCToolBoxLibrary.DataTypes.TagDataType.Float:
                                myCmd.Parameters.Add(new NpgsqlParameter("@" + field.DatabaseField, System.Data.DbType.String) { Value = value.ToString().Replace(',', '.') });
                                break;
                            case DotNetSiemensPLCToolBoxLibrary.DataTypes.TagDataType.DateTime:
                                myCmd.Parameters.Add(new NpgsqlParameter("@" + field.DatabaseField, System.Data.DbType.String) { Value = ((DateTime)value).ToString("dd-MM-yyyy HH:mm:ss") });
                                break;
                            ...
                            case DotNetSiemensPLCToolBoxLibrary.DataTypes.TagDataType.CharArray:
                                myCmd.Parameters.Add(new NpgsqlParameter("@" + field.DatabaseField, System.Data.DbType.String) { Value = (String)value });
                                break;
                        }
                        */
                    }
