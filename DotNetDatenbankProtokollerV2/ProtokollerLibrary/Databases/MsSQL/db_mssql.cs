...
{
    /*
    class db_mssql : IDbInterface
    {
        private string sql;

        public System.Data.SqlClient.SqlConnection myDBConn;
        private System.Data.SqlClient.SqlCommand myCmd;
        ...
        public bool Connect_To_Database(List<DbFeld> DBFelder, ProtokollDaten parProtokollDaten, DBConnections parDBConnection)
        {
            ...
            try
            {
                myDBConn = new System.Data.SqlClient.SqlConnection(myDBConnection.ConnectionString);
                myDBConn.Open();
            ...
            try
            {
                ...
                myCmd = new System.Data.SqlClient.SqlCommand(sql, myDBConn);
