    ...
    public class Node:ICloneable {
        ...
        public void Read(BinaryReader nfile) {
            ...
            for (i = 0; i < intGeneralKeysPerNode; i++) {
                ...
                if (objKeyType == dBaseType.N) { //Key is a double number
        ...
        public int LowerLevel{
            get {
                return lower_level[intPosition];
            }
            set {
                lower_level[intPosition] = value;
            }
        }

        public int KeysInNode{
            get {
                return intKeysInThisNode;
            }
            set {
                intKeysInThisNode = value;
            }
        }

        public NodeKey  KeyValue{
            get{
                return key_expression[intPosition];
            }
        }
        ...
        public Node NextNode {
            ...
            set {
                this.objNextNode = value;
            }
        }

        public Node PreviousNode {
            get {
                return objPreviousNode;
            }
            set {
                this.objPreviousNode = value;
            }
        }
