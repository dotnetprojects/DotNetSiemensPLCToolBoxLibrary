...
namespace DotNetSiemensPLCToolBoxLibrary.DBF {
    ...
    public static class dBaseConverter {
        ...
        public static DateTime D_ToDateTime(byte[] dBaseDateTimeBytes) {
            ...
            string sYear = DateTimeString.Substring(0, 4); int iYear;
            string sMonth = DateTimeString.Substring(4, 2); int iMonth;
            string sDay = DateTimeString.Substring(6, 2); int iDay;
