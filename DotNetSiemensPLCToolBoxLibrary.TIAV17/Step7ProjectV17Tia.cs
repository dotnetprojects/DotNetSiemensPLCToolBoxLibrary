...
namespace DotNetSiemensPLCToolBoxLibrary.Projectfiles.V17
{
    ...
    public partial class Step7ProjectV17
    {
        ...
        public class TIAOpennessVariablesFolder : TIAOpennessProjectFolder, ITIAVarTabFolder
        {
            ...
            public TIAOpennessVariablesFolder(Step7ProjectV17 Project, TIAOpennessControllerFolder ControllerFolder, PlcTagTableGroup group) : base(Project)
            {
        ...
        public class TIAOpennessWatchAndForceTablesFolder : TIAOpennessProjectFolder, ITIAWatchAndForceTablesFolder
        {
            ...
            public TIAOpennessWatchAndForceTablesFolder(Step7ProjectV17 Project, TIAOpennessControllerFolder ControllerFolder, PlcWatchAndForceTableGroup group) : base(Project)
            {
                this.ControllerFolder = ControllerFolder;
                this.Project = Project;
                this.TiaProject = Project;
        ...
        public class TIAOpennessPlcDatatypeFolder : TIAOpennessProjectFolder, IBlocksFolder, ITIAOpennessPlcDatatypeFolder
        {
            ...
            public TIAOpennessPlcDatatypeFolder(Step7ProjectV17 Project, TIAOpennessControllerFolder ControllerFolder, PlcTypeComposition composition, PlcTypeGroup plcTypeGroup)
                : base(Project)
            {
                this.ControllerFolder = ControllerFolder;
                this.Project = Project;
            ...
            public override ProjectFolder CreateFolder(string name)
            {
                ...
                var newFld = new TIAOpennessPlcDatatypeFolder((Step7ProjectV17)Project, ControllerFolder, gp.Types, gp);
                newFld.Name = gp.Name;
                newFld.Parent = this;
        ...
        public class TIAOpennessProgramFolder : TIAOpennessProjectFolder, IBlocksFolder, ITIAOpennessProgramFolder
        {
            ...
            public TIAOpennessProgramFolder(Step7ProjectV17 Project, TIAOpennessControllerFolder ControllerFolder, PlcBlockComposition blocks, PlcBlockGroup plcBlockGroup)
                : base(Project)
            {
                this.ControllerFolder = ControllerFolder;
                this.Project = Project;
            ...
            public override ProjectFolder CreateFolder(string name)
            {
                ...
                var newFld = new TIAOpennessProgramFolder((Step7ProjectV17)Project, ControllerFolder, gp.Blocks, gp);
                newFld.Name = gp.Name;
                newFld.Parent = this;
                this.SubItems.Add(newFld);
                return newFld;
        ...
        internal void LoadViaOpennessDlls()
        {
            ...
            {
                if (d.TypeIdentifier != null && d.TypeIdentifier.Contains("00") && d.TypeIdentifier.Contains("S7"))
                {
