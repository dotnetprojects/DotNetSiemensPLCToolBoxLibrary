...
namespace DotNetSiemensPLCToolBoxLibrary.Projectfiles.V19
{
    ...
    public partial class Step7ProjectV19
    {
        ...
        public class TIAOpennessVariablesFolder : TIAOpennessProjectFolder, ITIAVarTabFolder
        {
            ...
            public TIAOpennessVariablesFolder(Step7ProjectV19 Project, TIAOpennessControllerFolder ControllerFolder, PlcTagTableGroup group) : base(Project)
            {
        ...
        public class TIAOpennessWatchAndForceTablesFolder : TIAOpennessProjectFolder, ITIAWatchAndForceTablesFolder
        {
            ...
            public TIAOpennessWatchAndForceTablesFolder(Step7ProjectV19 Project, TIAOpennessControllerFolder ControllerFolder, PlcWatchAndForceTableGroup group) : base(Project)
            {
                this.ControllerFolder = ControllerFolder;
                this.Project = Project;
                this.TiaProject = Project;
        ...
        public class TIAOpennessPlcDatatypeFolder : TIAOpennessProjectFolder, IBlocksFolder, ITIAOpennessPlcDatatypeFolder
        {
            ...
            public TIAOpennessPlcDatatypeFolder(Step7ProjectV19 Project, TIAOpennessControllerFolder ControllerFolder, PlcTypeComposition composition, PlcTypeGroup plcTypeGroup)
                : base(Project)
            {
                this.ControllerFolder = ControllerFolder;
                this.Project = Project;
            ...
            public override ProjectFolder CreateFolder(string name)
            {
                ...
                var newFld = new TIAOpennessPlcDatatypeFolder((Step7ProjectV19)Project, ControllerFolder, gp.Types, gp);
                newFld.Name = gp.Name;
                newFld.Parent = this;
                this.SubItems.Add(newFld);
                return newFld;
        ...
        public class TIAOpennessProgramFolder : TIAOpennessProjectFolder, IBlocksFolder, ITIAOpennessProgramFolder
        {
            ...
            public TIAOpennessProgramFolder(Step7ProjectV19 Project, TIAOpennessControllerFolder ControllerFolder, PlcBlockComposition blocks, PlcBlockGroup plcBlockGroup)
                : base(Project)
            {
                this.ControllerFolder = ControllerFolder;
                this.Project = Project;
            ...
            public override ProjectFolder CreateFolder(string name)
            {
                ...
                var newFld = new TIAOpennessProgramFolder((Step7ProjectV19)Project, ControllerFolder, gp.Blocks, gp);
                newFld.Name = gp.Name;
                newFld.Parent = this;
                this.SubItems.Add(newFld);
                return newFld;
